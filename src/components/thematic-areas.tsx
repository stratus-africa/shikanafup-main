    ...
    <section className="py-12 md:py-16 bg-gray-50 border-t border-border">
      <div className="max-w-[1500px] mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Our strategic focus on economic prosperity, social inclusivity, and effective governance drives our mission
            to transform Kenya into a well-governed, thriving, and equitable nation for all citizens
          </motion.p>
        </div>
            ...
            return (
              ...
              >
                <Card className="h-full p-8 hover:shadow-lg transition-shadow border-none shadow-md bg-white flex flex-col">
                  ...
                  <Link href="/shared-ui/publications">
                    <Button
                      variant="outline"
                      className="group text-secondary border-secondary hover:bg-secondary hover:text-white"
                    >
                      Read More
