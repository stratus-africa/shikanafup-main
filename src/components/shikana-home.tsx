...
import { ArrowRight, HeartHandshake, MapPinned, ShieldCheck, Users, Vote } from "lucide-react";
...
export function ShikanaHome() {
  return (
    <main className="overflow-hidden bg-[#fcfcfa] text-[#162443]">
      {/* HERO — Shikana voting campaign visual */}
      <section className="relative bg-[#162443] pb-14 pt-6 sm:pb-20 sm:pt-10">
        <div className="mx-auto w-full max-w-[1400px] px-3 sm:px-8">
          <figure className="overflow-hidden rounded-2xl bg-[#bfe4f5] shadow-[0_28px_70px_-30px_rgba(0,0,0,.7)]">
            <img
              src={votingCampaign.url}
              alt="Shikana Frontliners for Unity Party campaign poster: We Rise, We Decide, We Vote! Truth, Always Conquers. Register to vote and check your voting particulars at https://verify.iebc.or.ke. Join the Shikana movement — no one should be left behind."
              width={1280}
              height={1600}
              fetchPriority="high"
              decoding="async"
              className="mx-auto block h-auto w-full max-h-[78vh] object-contain"
            />
          </figure>

          {/* Hero call to action */}
          <div className="mx-auto mt-10 max-w-4xl text-center">
            <p className="text-xs font-bold tracking-[0.2em] text-[#ecb23b] sm:text-sm">
              WE RISE &middot; WE DECIDE &middot; WE VOTE
            </p>
            ...
            <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
              ...
              <Link
                href="/shared-ui/register"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-7 py-4 font-bold text-[#162443] transition hover:-translate-y-0.5 hover:bg-[#ecb23b] focus:outline-none focus:ring-4 focus:ring-white/40"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/60 px-7 py-4 font-bold text-white transition hover:bg-white hover:text-[#162443] focus:outline-none focus:ring-4 focus:ring-white/40"
              >
                <ShieldCheck size={18} /> Check Your Voting Details
              </a>
            </div>
            <p className="mt-5 text-sm text-white/70">
              Already a member?{" "}
              <Link href="/login" className="font-bold text-[#ecb23b] underline-offset-4 hover:underline">
                Log in to your profile
              </Link>
            </p>
          </div>
        </div>
        {/* visual transition into the Nationalist Agenda */}
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-b from-transparent to-[#f4f1ed]" />
      </section>
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-5 py-24 sm:px-8 lg:grid-cols-2 lg:items-center lg:py-32">
        ...
        <div className="max-w-xl">
          <p className="text-sm font-bold tracking-[0.16em] text-[#c9232b]">A GENERATIONAL TRANSFORMATION</p>
          <h2 className="mt-4 text-4xl font-black leading-tight tracking-tight sm:text-5xl">
      ...
      <section className="border-y border-slate-200 bg-white px-5 py-24 sm:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <p className="text-center text-sm font-bold tracking-[0.16em] text-[#c9232b]">UPCOMING EVENTS</p>
      ...
      <section id="get-involved" className="bg-[#f4f1ed] px-5 py-20 sm:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <p className="text-sm font-bold tracking-[0.16em] text-[#c9232b]">FIND A GROUP NEAR YOU</p>
          <h2 className="mt-3 max-w-2xl text-4xl font-black tracking-tight sm:text-5xl">
            Shikana is where you are.
          </h2>
          <div className="mt-12 grid overflow-hidden rounded-2xl bg-white shadow-[0_18px_60px_rgba(22,36,67,.14)] sm:grid-cols-2 lg:grid-cols-4">
