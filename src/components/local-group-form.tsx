      ...
      <div className="max-w-[1500px] mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="text-foreground/70 leading-relaxed mb-12 lg:mb-0 lg:pr-8">
            ...
            <p className="mb-4">
              Local branches are the heartbeat of our movement. By organizing at the grassroots level, we ensure that
              every voice is heard and every community is represented.
            </p>
            <p className="mb-4">
              Join a local branch to participate in decision-making, coordinate initiatives, and work with neighbors to
              build a stronger foundation for our nation, one village at a time.
            </p>
